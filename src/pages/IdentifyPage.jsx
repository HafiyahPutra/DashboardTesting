    ...
    <div className="min-h-screen bg-gray-950 p-6">
      <div className="max-w-lg mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Monitor Identifikasi</h1>
          <p className="text-gray-400 text-sm mt-1">Status autentikasi Node 0 — realtime</p>
        </div>

        {/* Status Card */}
        <div className={`rounded-2xl p-6 mb-6 border-2 transition-all duration-500
          ${isAuthorized
            ? "bg-green-950 border-green-500 shadow-green-900/50 shadow-xl"
          ...
          <div className="flex items-center gap-4">
            ...
            {isAuthorized && (
              <div className="ml-auto text-right">
                <p className="text-gray-400 text-xs">Finger ID</p>
        ...
        <div className="bg-gray-900 rounded-2xl p-5 border border-gray-800">
          <h2 className="text-white font-semibold mb-4">Riwayat Akses (sesi ini)</h2>
          {history.length === 0 ? (
            <p className="text-gray-600 text-sm text-center py-4">Belum ada aktivitas</p>
          ) : (
            <ul className="space-y-2">
              {history.map((item, i) => (
                <li key={i} className="flex items-center justify-between bg-gray-800
